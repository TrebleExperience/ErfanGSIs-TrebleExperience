...
# Drop some themes
rm -rf $1/etc/AsusTheme/themes/com.asus.themes.bumper.ip0206.zip
rm -rf $1/etc/AsusTheme/themes/com.asus.themes.akira.zip
rm -rf $1/etc/AsusTheme/themes/com.asus.themes.anakin.zip

# Drop some system_ext apks
